...
let $griddashboard = {
    prop: {
        dataSet: [{
            WorkingDate: '07-14',
            WorkingTime: 8,
            ExtendedWorkingTime: 0
        },
        {
            WorkingDate: '07-15',
            WorkingTime: 8,
            ExtendedWorkingTime: 1.5
        },
        {
            WorkingDate: '07-16',
            WorkingTime: 8,
    ...
    method: {
        ...
        buildChartData() {
            ...
            for (var i = 0; i < workingDate.length; i++) {
                rows.push({
                    WorkingDate: workingDate[i],
                    WorkingTime: workingTime[i],
                    ExtendedWorkingTime: extendedWorkingTime[i]
                });
            }
            return rows;
        }
