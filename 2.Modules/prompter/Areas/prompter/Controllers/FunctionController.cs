...
namespace prompter.Areas.prompter.Controllers
{
    ...
    public class FunctionController : BaseController
    {
        ...
        public async Task<DataSet?> Execute([FromBody] List<DynamicParameter>? dynamicParameters, [FromQuery] DataContext? dataContext)
        {
            ...
            dataContext.workingDirectoryPath = !string.IsNullOrWhiteSpace(dataContext.workingDirectoryPath) ? dataContext.workingDirectoryPath : "../tmp/HDS/prompter/HDS_FN00";
        ...
        public string Get()
        {
            return "prompter FunctionController";
        }
