    ...
    event: {
        ...
        btnApplyConfig_click() {
            try {
                ...
                syn.$l.get('txtToolSecurityJson').value = JSON.stringify({
        ...
        btnJsonView_click() {
            if ($object.isNullOrUndefined($this.prop.moduleConfig) == false) {
                try {
                    ...
                    var toolSecurity = JSON.parse(syn.$l.get('txtToolSecurityJson').value || '{}');
            ...
            if (elID == 'ManageAction') {
                ...
                if (el && syn.$m.hasClass(el, 'show') == false) {
                    ...
                    if (data) {
                        ...
                        syn.$l.get('ddlLLMProvider_LLMSource').value = 'OpenAI';
