...
if [ "$TASK_COMMAND" == "copy" ]; then
    ...
    rsync -av $WORKING_PATH/Contracts/ $HANDSTACK_SRC/../build/handstack/modules/openapi/Contracts/
    rsync -av $WORKING_PATH/wwwroot/ $HANDSTACK_SRC/../build/handstack/modules/openapi/wwwroot/
fi
