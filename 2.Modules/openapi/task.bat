...
if "%TASK_COMMAND%"=="copy" (
    ...
    robocopy %WORKING_PATH%/Contracts %HANDSTACK_SRC%/../build/handstack/modules/openapi/Contracts /e /copy:dat
    robocopy %WORKING_PATH%/wwwroot %HANDSTACK_SRC%/../build/handstack/modules/openapi/wwwroot /e /copy:dat
)
