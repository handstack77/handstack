...
{
    public class OpenApiLoggerClient
    {
        ...
        public OpenApiLoggerClient(Serilog.ILogger logger, Serilog.ILogger? transactionLogger = null)
        {
            this.logger = logger;
            ...
            circuitBreakerPolicy = Policy
                ...
                {
                    logger.Error("[{LogCategory}] " + $"OpenApiLoggerClient CircuitBreaker Error Reason: {iRestResponse.Result.Content}", "CircuitBreaker/onBreak");
                },
                onReset: (context) =>
                {
