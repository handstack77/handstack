...
| `width` | string | `'100%'` | PropertyPanel 표시 영역의 너비. `px`, `%`, `calc(...)` 등 CSS에서 유효한 너비 값을 지정합니다. |
| `height` | string | `'300px'` | PropertyPanel 표시 영역의 높이. 내용이 영역을 넘으면 스크롤바가 자동으로 표시됩니다. |
