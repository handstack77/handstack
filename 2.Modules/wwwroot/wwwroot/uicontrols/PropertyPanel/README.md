# PropertyPanel (syn.uicontrols.$propertypanel)
...
`width`와 `height`로 PropertyPanel의 표시 영역 크기를 CSS 크기값으로 지정할 수 있습니다. 기본값은 각각 `100%`, `300px`이며, 내용이 표시 영역을 넘으면 가로 또는 세로 스크롤바가 자동으로 표시됩니다.
