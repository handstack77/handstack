...
if [ ! -d ../../1.WebHost/publish/handstack/modules/wwwroot ]; then 
    mkdir -p ../../1.WebHost/publish/handstack/modules/wwwroot
fi

rm -f $TargetDir/HandStack.*
rsync -avq --delete $target_dir ../../1.WebHost/publish/handstack/modules/wwwroot