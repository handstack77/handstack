...
if "%TASK_COMMAND%"=="copy" (
    ...
    robocopy %WORKING_PATH%/Contracts %HANDSTACK_HOME%/modules/wwwroot/Contracts /e /copy:dat
    robocopy %WORKING_PATH%/wwwroot/view %HANDSTACK_HOME%/modules/wwwroot/wwwroot/view /e /copy:dat
)

if "%TASK_COMMAND%"=="www" (
    robocopy %WORKING_PATH%/wwwroot %HANDSTACK_HOME%/modules/wwwroot/wwwroot /e /copy:dat /xd %WORKING_PATH%\wwwroot\lib /xf syn.config.json
)

if "%TASK_COMMAND%"=="lib" (
    robocopy %WORKING_PATH%/wwwroot %HANDSTACK_HOME%/modules/wwwroot/wwwroot /e /copy:dat
)

if "%TASK_COMMAND%"=="syn" (
    robocopy %WORKING_PATH%/wwwroot/js %HANDSTACK_HOME%/modules/wwwroot/wwwroot/js /XF syn.domain.js syn.domain.min.js syn.loader.js syn.loader.min.js /LEV:1 /R:0 /W:0
    robocopy %WORKING_PATH%/wwwroot/uicontrols %HANDSTACK_HOME%/modules/wwwroot/wwwroot/uicontrols /e /copy:dat /xd %WORKING_PATH%\wwwroot\lib
)
