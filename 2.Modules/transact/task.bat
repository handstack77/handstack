...
if "%HANDSTACK_CLI%" == "" set HANDSTACK_CLI=%HANDSTACK_PATH%/4.Tool/CLI/handstack/bin/Debug/net9.0/handstack
...
if "%TASK_COMMAND%"=="copy" (
    ...
    robocopy %WORKING_PATH%/Contracts %HANDSTACK_PATH%/1.WebHost/build/handstack/modules/transact/Contracts /e /copy:dat
    robocopy %WORKING_PATH%/wwwroot %HANDSTACK_PATH%/1.WebHost/build/handstack/modules/transact/wwwroot /e /copy:dat
)
