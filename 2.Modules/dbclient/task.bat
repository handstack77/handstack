...
if "%TASK_COMMAND%"=="copy" (
    ...
    robocopy %WORKING_PATH%/Contracts %HANDSTACK_PATH%/1.WebHost/build/handstack/modules/dbclient/Contracts /e /copy:dat
    robocopy %WORKING_PATH%/wwwroot %HANDSTACK_PATH%/1.WebHost/build/handstack/modules/dbclient/wwwroot /e /copy:dat
)
