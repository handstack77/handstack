...
namespace logger.Extensions
{
    public static class ModuleExtensions
    {
         ...
         */
        public static dynamic? ExecuteMetaSQL(ReturnType returnType, string applicationID, string queryID, object? parameters = null)
        {
            dynamic? result = null;
                    ...
                    if (dataSource != null)
                    {
                        ...
                        switch (dataProvider)
                        {
                            case DataProviders.SqlServer:
                                var sqlServerMeta = DatabaseExtensions.GetSqlClientMetaSQL(ModuleConfiguration.ModuleBasePath, applicationID, paths[0], paths[1], paths[2], parseParameters);
                            ...
                            case DataProviders.Oracle:
                                var oracleMeta = DatabaseExtensions.GetOracleMetaSQL(ModuleConfiguration.ModuleBasePath, applicationID, paths[0], paths[1], paths[2], parseParameters);
                                if (oracleMeta != null)
                                {
                                    JObject? adHocParameters = parseParameters == null ? null : JObject.Parse(parseParameters);
                            ...
                            case DataProviders.MySQL:
                                var mySqlMeta = DatabaseExtensions.GetMySqlMetaSQL(ModuleConfiguration.ModuleBasePath, applicationID, paths[0], paths[1], paths[2], parseParameters);
                                if (mySqlMeta != null)
                                {
                                    JObject? adHocParameters = parseParameters == null ? null : JObject.Parse(parseParameters);
                            ...
                            case DataProviders.PostgreSQL:
                                var postgreSqlMeta = DatabaseExtensions.GetPostreSqlMetaSQL(ModuleConfiguration.ModuleBasePath, applicationID, paths[0], paths[1], paths[2], parseParameters);
                            ...
                            case DataProviders.SQLite:
                                var sqliteMeta = DatabaseExtensions.GetSQLiteMetaSQL(ModuleConfiguration.ModuleBasePath, applicationID, paths[0], paths[1], paths[2], parseParameters);
                                if (sqliteMeta != null)
                                {
                                    JObject? adHocParameters = parseParameters == null ? null : JObject.Parse(parseParameters);
