...
if "%TASK_COMMAND%"=="copy" (
    ...
    robocopy %WORKING_PATH%/Contracts %HANDSTACK_HOME%/modules/logger/Contracts /e /copy:dat
    robocopy %WORKING_PATH%/wwwroot %HANDSTACK_HOME%/modules/logger/wwwroot /e /copy:dat
)
