...
if [ "$TASK_COMMAND" == "copy" ]; then
    ...
    rsync -av $WORKING_PATH/Contracts/ $HANDSTACK_PATH/1.WebHost/build/handstack/modules/checkup/Contracts/
    rsync -av $WORKING_PATH/wwwroot/ $HANDSTACK_PATH/1.WebHost/build/handstack/modules/checkup/wwwroot/
fi
