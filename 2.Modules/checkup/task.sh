...
if [ "$TASK_COMMAND" == "copy" ]; then
    ...
    rsync -av $WORKING_PATH/Contracts/ $HANDSTACK_SRC/../build/handstack/modules/checkup/Contracts/
    rsync -av $WORKING_PATH/wwwroot/ $HANDSTACK_SRC/../build/handstack/modules/checkup/wwwroot/
fi
