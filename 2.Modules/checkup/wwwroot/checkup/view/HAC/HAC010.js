            ...
            action(evt) {
                ...
                if (syn.$l.get('ddlDataProvider').value == 'SQLite') {
                    ...
                    if (fileName == '') {
                        ...
                        syn.$l.get('txtConnectionString').value = `URI=file:{appBasePath}/.managed/sqlite/${fileName};Journal Mode=MEMORY;Cache Size=4000;Synchronous=Normal;Page Size=4096;Pooling=True;BinaryGUID=False;DateTimeFormat=Ticks;Version=3;`;
                    }
                }
