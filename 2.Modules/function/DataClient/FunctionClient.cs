                ...
                foreach (var transactionDynamicObject in transactionDynamicObjects)
                {
                    ...
                    if (queryObject.Parameters.Count() > 0)
                    {
                        ...
                        foreach (var moduleParameterMap in moduleParameterMaps)
                        {
                            ...
                            dynamicParameter.DbType = string.IsNullOrWhiteSpace(moduleParameterMap.DbType) ? dynamicParameter.DbType : moduleParameterMap.DbType;
                    ...
                    if (!string.IsNullOrWhiteSpace(moduleScriptMap.BeforeTransactionCommand))
                    {
                        var logData = "";
                    ...
                    else if (moduleScriptMap.LanguageType == "csharp")
                    {
                        try
                        {
                            ...
                            if (string.IsNullOrWhiteSpace(moduleScriptMap.EntryType) || string.IsNullOrWhiteSpace(moduleScriptMap.EntryMethod))
                            {
                    ...
                    {
                        if (!string.IsNullOrWhiteSpace(moduleScriptMap.FallbackTransactionCommand))
                        {
                    ...
                    if (!string.IsNullOrWhiteSpace(moduleScriptMap.AfterTransactionCommand))
                    {
