...
if "%TASK_COMMAND%"=="copy" (
    ...
    robocopy %WORKING_PATH%/Contracts %HANDSTACK_HOME%/modules/function/Contracts /e /copy:dat
    robocopy %WORKING_PATH%/wwwroot %HANDSTACK_HOME%/modules/function/wwwroot /e /copy:dat
)
