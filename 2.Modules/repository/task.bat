...
if "%TASK_COMMAND%"=="copy" (
    ...
    robocopy %WORKING_PATH%/Contracts %HANDSTACK_SRC%/../build/handstack/modules/repository/Contracts /e /copy:dat
    robocopy %WORKING_PATH%/wwwroot %HANDSTACK_SRC%/../build/handstack/modules/repository/wwwroot /e /copy:dat
)
