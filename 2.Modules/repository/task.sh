...
if [ "$TASK_COMMAND" == "copy" ]; then
    ...
    rsync -av $WORKING_PATH/Contracts/ $HANDSTACK_PATH/1.WebHost/build/handstack/modules/repository/Contracts/
    rsync -av $WORKING_PATH/wwwroot/ $HANDSTACK_PATH/1.WebHost/build/handstack/modules/repository/wwwroot/
fi
