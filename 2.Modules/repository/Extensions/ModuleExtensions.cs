...
namespace repository.Extensions
{
    ...
    {
        /*
        var dynamicFiles = ModuleExtensions.ExecuteMetaSQL(ReturnType.Dynamic, repository, "STR.STR010.LD02", new
        {
        ...
        public static dynamic? ExecuteMetaSQL(ReturnType returnType, Repository repository, string queryID, object? parameters = null)
        {
            ...
            if (string.IsNullOrEmpty(repository.SQLiteConnectionString) == true)
            {
