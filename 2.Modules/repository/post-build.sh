...
if [ ! -d ../../1.WebHost/ack/build/handstack/modules/repository ]; then 
    mkdir -p ../../1.WebHost/ack/build/handstack/modules/repository
fi

rsync -avq "$target_dir"Contracts/ ../../1.WebHost/ack/build/handstack/contracts
rm -f $TargetDir/HandStack.*
rsync -avq $target_dir ../../1.WebHost/ack/build/handstack/modules/repository