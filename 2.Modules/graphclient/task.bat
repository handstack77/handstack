...
if "%TASK_COMMAND%"=="copy" (
    ...
    robocopy %WORKING_PATH%/Contracts %HANDSTACK_HOME%/modules/graphclient/Contracts /e /copy:dat
    robocopy %WORKING_PATH%/wwwroot %HANDSTACK_HOME%/modules/graphclient/wwwroot /e /copy:dat
)
