...
rmdir /s /q C:\publish\%os_mode%-%arch_mode%\cli\handstack
dotnet %action_mode% handstack.csproj --configuration %configuration_mode% --arch %arch_mode% --os %os_mode% --output C:/publish/%os_mode%-%arch_mode%/cli/handstack
